...
public class Mapa3 extends BasicGameState {
    ...
    private final Personajes personaje = new Personajes(col, 272, 848, 1040, 112, 112, 368);
    ...
    private final Objetos obj = new Objetos(col, 576, 128, 64, 592, 1152, 224);
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException {
        //Cargamos el mapa
        mapa = new TiledMap("./Mapas/mapa_final1.2.tmx");
    ...
    public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
        ...
        g.drawString("Tarjetas recogidas: " + col.getTarjeta3() + "/2", 310, 10);
    ...
    public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException {
        ...
        //... y la música está activada, iniciamos la música del Mapa3        
        ...
        //Si el personaje atraviesa el Mapa3 pasa al estado 5
        if (col.cambiarMapa3()) {
            juliantheme.stop();
            if (sonido.isSonidoOn()) {
